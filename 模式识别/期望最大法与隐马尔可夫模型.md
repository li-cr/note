...
$\Huge\begin{aligned} \frac{\partial Q}{\partial z_i} &= \sum\limits_i\sum\limits_z\frac{\Huge\epsilon_{zi}}{\pi_z}\quad\Big[\,\sum\limits_z\pi_z=1,\;\pi_z\ge0\,\Big] \\ \frac{\partial Q}{\partial \mu_i} &=\end{aligned}$