...
#### <span style="color:#6980f2">$\large{假设 \Sigma_i=\sigma^2  I, i=1, 2, \dots,c}$</span>
$$
\large{
\begin{aligned}
...
#### <span style="color:#6980f2">$\large{假设 \Sigma_i=\Sigma, i=1, 2, \dots,c}$</span>
$$
\large{
\begin{aligned}
...
#### <span style="color:#6980f2">假设</span>
