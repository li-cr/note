...
& \mu_i^T\mu_i-\mu_j^T\mu_j=(\mu_i-\mu_j)^T(\mu_-\mu_j)\\
\end{aligned}
...
> $\huge{-\frac{1}{2}\Big((x-\mu_i)^T\Sigma_i^{-1}(x-\mu_i) - (x-\mu_j)^T\Sigma_j^{-1}(x-\mu_j) \Big) - \frac{1}{2}\ln{\Big(\frac{|\Sigma_i|}{|\Sigma_j|}\Big)} + \ln\Big(\frac{|P(\omega_i|}{|P(\omega_j)|}\Big)}$


$假设 \Sigma_i=\sigma^2  I, i=1, 2, \dots,c$

$$
\huge{
\begin{aligned}
g(x) &=-\frac{1}{2\sigma^2}\Big( -2\mu^Tx+\mu^T\mu  \Big)-\frac{1}{2}\ln(P(\omega))  \quad [\,x^Tx,\frac{d}{2}\ln(2\pi)],\ln(|\Sigma_i|) 相等\quad \forall \,i \in{1,2,\dots,c} \;] \\
&=\frac{1}{\sigma^2}\mu^Tx-(\frac{1}{2}\ln(P(\omega))+\frac{1}{2\sigma^2}u^Tu)\\
\end{aligned}
}
$$
