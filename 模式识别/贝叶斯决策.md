...
g(x_i)-g(x_j)=0&\implies w^T(x-x_0)=0\quad [w=\frac{\mu_i-\mu_j}{\sigma^2}\quad x_0=\frac{1}{2}(\mu_i+\mu_j)-s_{ij}(\mu_i-\mu_j)\quad s_{ij}=\ln(\frac{P(\omega_i)}{P(\omega_j)})\frac{\sigma^2}{||u_i-u_j||}]
\end{aligned}
}
$$
